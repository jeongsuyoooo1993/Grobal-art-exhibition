...
/**
 * DATA: World Class Museums with Exhibition Lists
 */
...
const App = () => {
  ...
  return (
    <div className="bg-[#0a0a0a] text-white w-full min-h-screen font-sans selection:bg-white selection:text-black">
      ...
      {/* HEADER */}
      <header className="fixed top-0 left-0 w-full z-40 flex justify-between items-center p-8 mix-blend-difference pointer-events-none">
        <div className="text-xs uppercase tracking-widest font-bold pointer-events-auto">
          The Living Archive
        </div>
